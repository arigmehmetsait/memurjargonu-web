...
export default function AdminDenemelerPage() {
  ...
  const handleCreateDeneme = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/admin/denemeler/create", {
        method: "POST",
        headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/admin/denemeler/delete?denemeId=${encodeURIComponent(
          denemeToDelete.id
        )}`,
        {
          method: "DELETE",
  ...
  return (
    <AdminGuard>
      <Head>
        ...
        <meta name="description" content="Mevzuat denemeleri yönetimi" />
      </Head>
                        ...
                        <td>
                          <div className="btn-group" role="group">
                            <button
                              ...
                              onClick={() => {
                                window.open(
                                  `/denemeler/${encodeURIComponent(deneme.id)}`,
                                  "_blank"
                                );
                              }}
                            >
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p>
                  <strong>"{denemeToDelete.name}"</strong> denemesini silmek
