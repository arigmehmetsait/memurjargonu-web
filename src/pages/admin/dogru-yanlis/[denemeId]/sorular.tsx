...
export default function AdminDogruYanlisSorularPage() {
  ...
  const [dogruCevap, setDogruCevap] = useState<number>(0); // 0: Doğru, 1: Yanlış
      ...
      const response = await fetch(
        ...
        )}/sorular`,
        {
          ...
          body: JSON.stringify({
            ...
            correctAnswer: dogruCevap === 0 ? "Doğru" : "Yanlış",
            options: ["Doğru", "Yanlış"],
            explanation: aciklama.trim(),
            difficulty: "orta",
            subject: "Doğru-Yanlış",
          }),
        }
      );
  ...
  const handleEditSoru = (soru: Soru) => {
    ...
    setDogruCevap(soru.dogruSecenek);
  ...
  return (
    <AdminGuard>
      <Head>
        ...
        <meta name="description" content="Doğru-Yanlış soruları yönetimi" />
      </Head>
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
              <div>
                ...
                <p className="text-muted mb-0">
                  {denemeData?.denemeName || denemeId} - Doğru-Yanlış Denemesi
                </p>
              </div>
              <div>
                <button
                  className="btn btn-outline-secondary me-2"
                  onClick={() => router.push("/admin/dogru-yanlis")}
                >
            ...
            {loading ? (
              ...
              <div className="text-center py-5">
                ...
                <p className="text-muted">
                  Bu doğru-yanlış denemesine henüz hiç soru eklenmemiş.
                </p>
                <button
                      ...
                      <div className="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div className="btn-group btn-group-sm">
                          <button
                            ...
                            onClick={() => {
                              // Soru detaylarını modal'da göster
                              setEditingSoru(soru);
                              setSoruText(soru.soru);
                              setDogruCevap(soru.dogruSecenek);
                              setAciklama(soru.aciklama || "");
                ...
                <div className="card bg-light">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      {
                        denemeData.sorular.filter((s) => s.dogruSecenek === 0)
                          .length
                      }
                      <br />
                      <strong>Yanlış Cevaplar:</strong>{" "}
                      {
                        denemeData.sorular.filter((s) => s.dogruSecenek === 1)
                          .length
                      }
                    </p>
                  </div>
                  ...
                  <div className="d-flex gap-3">
                    <div className="form-check">
                      <input
                        ...
                        id="dogru"
                        value="0"
                        checked={dogruCevap === 0}
                        onChange={(e) =>
                          setDogruCevap(parseInt(e.target.value))
                        }
                        disabled={saving}
                      />
                      <label
