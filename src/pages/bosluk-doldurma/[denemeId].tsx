...
interface Cevap {
  soruId: string;
  cevap: number; // Seçenek index'i
}

export default function BoslukDoldurmaDenemePage() {
  ...
  return (
    <>
      <Head>
        <title>{denemeData.denemeName} - Boşluk Doldurma Denemesi</title>
        <meta
          name="description"
          content={`${denemeData.denemeName} boşluk doldurma denemesi`}
        />
      </Head>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <div className="text-center mb-4">
              ...
              <p className="text-muted">Boşluk Doldurma Denemesi</p>
            </div>
                ...
                <div className="card-body text-center">
                  ...
                  <div className="d-grid gap-2 d-md-flex justify-content-md-center">
                    ...
                    <button
                      ...
                      onClick={() => router.push("/bosluk-doldurma")}
                    >
                      <i className="bi bi-arrow-left me-2"></i>
                      Diğer Denemeler
                    </button>
