...
export default async function handler(
  ...
  try {
    ...
    const denemeRef = adminDb.collection("RealCografyaDenemeler").doc(id);
    ...
    console.log(`Coğrafya denemesi güncellendi: ${id}`);
    ...
    console.error("Coğrafya denemesi güncelleme hatası:", error);
    res.status(500).json({
      success: false,
