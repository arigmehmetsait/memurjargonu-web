...
export default async function handler(
  ...
  if (req.method === "GET") {
    ...
    try {
      ...
      // Eski format desteği (soru, cevap, secenekler) veya yeni format (questionText, correctAnswer, options)
      ...
      // Soruyu ekle
      await denemeRef.collection("sorular").doc(soruId).set(soruData);
